  ...
  return (
    <div className={classes.usersidebar}>
      ...
      {activepage === "changepassword" ? (
        ...
        <Link to="/auth/employee/changepassword" className={classes.stylenone}>
          <div className={classes.s1}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      {activepage === "yourorders" ? (
        ...
        <Link to="/auth/employee/orders" className={classes.stylenone}>
          <div className={classes.s1}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      {activepage === "yourappointments" ? (
        ...
        <Link to="/auth/employee/appointments" className={classes.stylenone}>
          <div className={classes.s1}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      {activepage === "notifications" ? (
        ...
        <Link to="/auth/employee/notifications" className={classes.stylenone}>
          <div className={classes.s1}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
