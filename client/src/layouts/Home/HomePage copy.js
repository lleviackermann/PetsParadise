          ...
          <div className="left">
            <div className="heading">
              <h1 className="heading__top">
                pet1<span>Paradise</span><img src={dogSketch} className='dog-sketch' alt="" />
              </h1>
              <br />
              ...
              <div className="heading__end">
                We provide you <span className="multiText"></span>
              </div>
            </div>
      ...
      <section className="our__services">
        ...
        <div className="services">
          <div className="services__info">
            ...
            <div onClick={goToServicesPage}><button class="services__button" type="submit">
              Learn more<span>&rarr;</span>
            </button></div>
          </div>
          <div className="services__add">
